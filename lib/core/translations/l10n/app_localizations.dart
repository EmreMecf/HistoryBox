...
abstract class AppLocalizations {
  ...
  /// No description provided for @add_favorite_button.
  ///
  /// In en, this message translates to:
  /// **'Add to Favorites'**
  String get add_favorite_button;

  /// No description provided for @remove_favorite_button.
  ///
  /// In en, this message translates to:
  /// **'Remove from Favorites'**
  String get remove_favorite_button;
