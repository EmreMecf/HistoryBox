...
class StoryCreateViewModel with ChangeNotifier {
  ...
  // Masal dili (varsayılan Türkçe)
  String _language = 'Türkçe';
  String get language => _language;

  void setChildName(String? value) => _childName = value;
  void setInterests(String? value) => _interests = value;
  ...
  Future<void> _loadTopicSuggestions(String category) async {
    try {
      ...
      final result = await _aiStoryService.suggestTopics(category, language: _language);
